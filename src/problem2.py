...
def problem2a(circle, rectangle, window):
    ...
    finish = rectangle.get_lower_left_corner()
...
def problem2b(rect, n, delta, win):
    ...
    for k in range(n - 1):
        corner1 = rg.Point(rect.get_upper_right_corner().x + delta, rect.get_upper_right_corner().y - delta)
        corner2 = rg.Point(rect.get_lower_left_corner().x - delta, rect.get_lower_left_corner().y + delta)

...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 1.019  # This is APPROXIMATELY the correct answer.
    answer = problem1a(23, 546)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -0.668  # This is APPROXIMATELY the correct answer.
    answer = problem1a(67, 248)
    print()
